          ...
          <div className="about-content">
            <section className="about-section">
              <p className="intro-paragraph">
                Paradise Nursery es una tienda en linea especializada en plantas de interior,
                dedicada a ayudar a las personas a crear espacios verdes y armoniosos en sus hogares.
                Ofrecemos una amplia variedad de plantas cuidadosamente seleccionadas para todos los
                niveles de experiencia en jardineria.
              </p>
            </section>
            <section className="about-section">
            ...
            <section className="about-section">
              ...
              <ul>
                ...
                <li>Envío seguro con garantia de llegada en perfectas condiciones</li>
